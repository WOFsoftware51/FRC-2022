...
public class Five_Ball_Auton_Far extends SequentialCommandGroup 
{
  /** Creates a new One_Ball_Auto. */
  public Five_Ball_Auton_Far(Shooter m_shooter, Intake m_intake, DrivetrainSubsystem m_drivetrain) 
  {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new Auton_Intialize(m_drivetrain,m_intake),
      new ParallelRaceGroup(new Intake_On_Auton(m_intake, 200), new Drive_Auton_Heading(m_drivetrain, 0.2, -0.0, 0.0, 38000.0, true)), //111111
      new Auton_Step(1),
      ...
      new Auton_Step(1),
      new ParallelRaceGroup(new Intake_On_Auton(m_intake, 200), new Drive_Auton_Heading(m_drivetrain, -0.15, 0.3, 0.0, 37001.0, true), new Auton_Preload_Ball(m_shooter, 200)),  //80"
      new Auton_Step(1),
      new Auton_Aim_On(m_drivetrain),
      //new Drive_Auton_Heading(m_drivetrain, -0.3, -0.0, 0.0, 34000.0, false),                                                              //50"
      new Shoot_Auton_Far(m_shooter,150),
      new Auton_Aim_Off(m_drivetrain),
      new Auton_Step(1),
      new ParallelRaceGroup(new Intake_On_Auton(m_intake, 1000), new Drive_Auton_Heading(m_drivetrain, 0.40, -0.5, -45.0, 104000.0, false)), //250"
      new Auton_Step(1),
