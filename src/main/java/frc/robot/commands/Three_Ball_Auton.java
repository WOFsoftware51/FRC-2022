...
public class Three_Ball_Auton extends SequentialCommandGroup 
{
  /** Creates a new One_Ball_Auto. */
  public Three_Ball_Auton(Shooter m_shooter, Intake m_intake, DrivetrainSubsystem m_drivetrain) 
  {
    ...
    addCommands(
      ...
      new Drive_Auton_Heading(m_drivetrain, 0.4, 0.0, 0.0, 30000.0, true), 
      new Auton_Step(1),
      new Drive_Auton_Heading(m_drivetrain, 0.1, 0.0, 116.0, 50000.0, false), //250"
      new Auton_Step(1),
